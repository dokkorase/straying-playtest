...
console.log("### STRAYING CUSTOM KEYCONFIG LOADED ###");
...
console.log(
    "### KEYCONFIG AFTER LOAD ###",
    window.__tyrano_key_config.mouse.wheel_up,
    window.__tyrano_key_config.mouse.wheel_down
);