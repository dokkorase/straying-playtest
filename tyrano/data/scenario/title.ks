...
// --------------------------------------------------
// タイトルBGMは最初のユーザー操作で開始
// --------------------------------------------------

$(document).off('pointerdown.strayingTitleBgm');

$(document).one('pointerdown.strayingTitleBgm', function () {

    if (window.strayingTitleBgmStarted) {
        return;
    }

    window.strayingTitleBgmStarted = true;
